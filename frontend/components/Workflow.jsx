    ...
    <section id="workflow-section" className="w-full max-w-[1280px] mx-auto px-6 py-32 mt-16 border-t border-[rgba(255,255,255,0.05)]">
      <div className="text-center mb-20 max-w-3xl mx-auto">
        ...
        <p className="text-[#a1a1aa] text-lg leading-relaxed">
          Blinkshare isn't just another file host. It is a purpose-built pipeline designed to protect intellectual property, large media assets, and sensitive documents from end to end. Here is exactly what happens when you hit upload.
        </p>
      </div>
