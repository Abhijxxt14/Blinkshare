  ...
  return (
    <div className="w-full flex flex-col items-start text-left">
      ...
      <div className="inline-flex items-center gap-3 bg-[rgba(255,255,255,0.03)] border border-[rgba(255,255,255,0.1)] rounded-full px-5 py-2 mb-8 backdrop-blur-md flex-wrap">
        ...
        <div className="hidden sm:block w-px h-3 bg-[rgba(255,255,255,0.2)]"></div>
        <span className="flex items-center gap-2 text-xs font-semibold text-[#a1a1aa] tracking-wider uppercase"><div className="w-1.5 h-1.5 rounded-full bg-[#d946ef] shadow-[0_0_8px_#d946ef]"></div>Military-Grade Encryption</span>
      </div>
      ...
      <p className="text-lg text-[#a1a1aa] mb-10 leading-relaxed font-light max-w-xl">
        Blinkshare eliminates the bottleneck of traditional file sharing. Upload gigabytes of data securely, share the encrypted link instantly, and retrieve the exact, uncompressed file with absolute fidelity.
      </p>
